...
def load_dataset_config():
    ...
    config = {
        "dataset_root": os.getenv(
            "DATASET_ROOT", "/path/to/your/datasets/New_SwallowSet"
        ),
        "raw_data_dir": os.getenv(
            "RAW_DATA_DIR", "/path/to/your/datasets/New_SwallowSet/Raw"
        ),
        "short_audio_dir": os.getenv(
            "SHORT_AUDIO_DIR", "/path/to/your/datasets/New_SwallowSet/Test"
        ),
        "long_audio_dir": os.getenv(
            "LONG_AUDIO_DIR", "/path/to/your/datasets/New_SwallowSet/Long"
        ),
    }
...
def get_spectrogram_dir():
    """Get the spectrogram directory."""
    config = load_dataset_config()
    return config["spectrogram_dir"]
